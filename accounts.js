...
var firebase = new Firebase('https://wikiphidia.firebaseio.com/');
...
router.use(require('express-session')({
	...
	secret: 'aksjda;sldj324daas;dklajd;alsjdalskdjajlsd;as'
}));

router.post('/api/signup', function (res,req){
...
router.post('/api/signin', function (res,req){
	var username = req.body.username,
		password = req.body.password;
