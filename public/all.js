...
var signin = function signin(username, password) {
  return post('/api/singin', { username: username, password: password });
};
exports.signin = signin;
var signup = function signup(username, password) {
  return post('/api/singup', { username: username, password: password });
};
exports.signup = signup;
var signout = function signout() {
  return post('/api/singout');
};

exports.signout = signout;
var pages = new _firebase2['default']('https://wikiphidia.firebaseio.com/');
exports.pages = pages;

},{"firebase":1}],198:[function(require,module,exports){
'use strict';
...
},{"./Login":200,"react":196,"react-router":27}],200:[function(require,module,exports){
'use strict';
